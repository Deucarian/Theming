...
3. Use its buttons to exercise play with c#, play with component.
4. Inspect the configured hosts and triggers, then open
   [ThemingWorkflow.cs](../Samples~/DefinitionWorkflow/Runtime/ThemingWorkflow.cs). It is the caller
...
- **Play with C#**: `ThemingWorkflow.Play()`.
- **Play with component**: `ThemingWorkflow.PlayComponent()`.
