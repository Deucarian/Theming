...
namespace Deucarian.Theming.Editor.Tests
{
    public sealed class DeucarianThemingInspectorListFilterTests
    {
        ...
        [Test]
        public void RoleLibrarySearchesMetadataAndKeepsReservedCategoriesDistinct()
        {
            DeucarianColorRole surface = CreateRole(
                ...
                "Canvas Role Asset");
            DeucarianColorRole reservedAll = CreateRole(
                "deucarian.report.reserved.all",
                "Authored All",
                "All Categories",
                "Authored category named all categories",
                "Reserved All Role");
            DeucarianColorRole reservedUncategorized = CreateRole(
                "deucarian.report.reserved.uncategorized",
                "Authored Uncategorized",
                "Uncategorized",
                "Authored category named uncategorized",
                "Reserved Uncategorized Role");
            DeucarianColorRole reservedMissing = CreateRole(
                "deucarian.report.reserved.missing",
                "Authored Missing",
                "Missing",
                "Authored category named missing",
                "Reserved Missing Role");
            ...
            library.AddRole(reservedAll);
            library.AddRole(reservedUncategorized);
            library.AddRole(reservedMissing);
            ...
            roles.arraySize = 6;
            roles.GetArrayElementAtIndex(5).objectReferenceValue = null;
            ...
            AssertIndices(roles, DeucarianThemingInspectorListKind.ColorRoleLibraryRoles, "annotation markup", null, 4);
            AssertIndices(roles, DeucarianThemingInspectorListKind.ColorRoleLibraryRoles, "unassigned role", null, 5);
            AssertIndices(roles, DeucarianThemingInspectorListKind.ColorRoleLibraryRoles, " \t\r\n ", null, 0, 1, 2, 3, 4, 5);
            ...
            AssertIndices(roles, DeucarianThemingInspectorListKind.ColorRoleLibraryRoles, string.Empty, "All Categories", 1);
            AssertIndices(roles, DeucarianThemingInspectorListKind.ColorRoleLibraryRoles, string.Empty, "Uncategorized", 2);
            AssertIndices(roles, DeucarianThemingInspectorListKind.ColorRoleLibraryRoles, string.Empty, "Missing", 3);
            AssertIndices(
                roles,
                DeucarianThemingInspectorListKind.ColorRoleLibraryRoles,
                string.Empty,
        ...
        [Test]
        public void PaletteSearchesNotesAndRoleMetadataInStableOriginalOrder()
        {
            ...
            AssertIndices(entries, DeucarianThemingInspectorListKind.ColorPaletteEntries, " ", null, 0, 1, 2);
        ...
        [Test]
        public void ThemePackSearchesAllInlineRoleFieldsAndUncategorizedRoles()
        {
        ...
        [Test]
        public void UIToolkitBindingsSearchTargetsEnumsVariablesAndReferencedRoleMetadata()
        {
            DeucarianColorRole surface = CreateRole(
        ...
        [Test]
        public void UIToolkitVariableMappingsSearchVariablesAndReferencedRoleMetadata()
        {
            DeucarianColorRole surface = CreateRole(
                "deucarian.report.surface.raised",
                "Raised Surface",
        ...
        [Test]
        public void FilteredObjectReferenceDeletionUsesOriginalIndexAndUndoRestoresIt()
        {
            DeucarianColorRole first = CreateRole("deucarian.first", "First", "Surface", string.Empty, "First");
            DeucarianColorRole remove = CreateRole("deucarian.remove", "Delete Target", "Surface", string.Empty, "Remove");
        ...
        [Test]
        public void FilteredSerializableDeletionUsesOriginalIndexAndUndoRestoresIt()
        {
            DeucarianColorRole first = CreateRole("deucarian.first", "First", "Surface", string.Empty, "First");
            DeucarianColorRole remove = CreateRole("deucarian.remove", "Delete Target", "Status", string.Empty, "Remove");
            DeucarianColorRole last = CreateRole("deucarian.last", "Last", "Surface", string.Empty, "Last");
            DeucarianColorPalette palette = CreateObject<DeucarianColorPalette>();
        ...
        [Test]
        public void ThemePackCustomEditorUsesNativeUnfilteredInspectorForMultiSelection()
        {
            ...
            Assert.IsTrue(Attribute.IsDefined(
                ...
                false));
            Assert.IsFalse(DeucarianThemePackEditor.UsesNativeUnfilteredInspector(singleEditor.serializedObject));
            Assert.IsTrue(DeucarianThemePackEditor.UsesNativeUnfilteredInspector(multiEditor.serializedObject));
            Assert.AreEqual(2, multiEditor.targets.Length);
        }

        [Test]
        public void BindingSummaryUsesTheSameVisibleOriginalIndicesAsTheFilter()
        {
            CollectionAssert.IsEmpty(
                DeucarianUIToolkitThemeApplierEditor.GetBindingSummaryIndices(4, null));
            CollectionAssert.AreEqual(
                new[] { 0, 2 },
                DeucarianUIToolkitThemeApplierEditor.GetBindingSummaryIndices(4, new[] { 0, 2, 4, -1 }));
            CollectionAssert.IsEmpty(
                DeucarianUIToolkitThemeApplierEditor.GetBindingSummaryIndices(4, Array.Empty<int>()));
        }
