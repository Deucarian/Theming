...
{
    internal static class DeucarianThemeManagerFields
    {
        internal static UnityEngine.Object DrawWorkbenchObjectField(
            string label,
        ...
        internal static Enum DrawWorkbenchEnumPopup(string label, Enum value)
        {
            GetWorkbenchFieldRects(out Rect labelRect, out Rect fieldRect);
            EditorGUI.LabelField(
                labelRect,
        ...
        internal static void GetWorkbenchFieldRects(out Rect labelRect, out Rect fieldRect)
        {
        ...
        internal static void DrawAssetDropdown<T>(
            string label,
            T selected,
