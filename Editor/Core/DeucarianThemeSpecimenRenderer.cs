...
{
    internal static class DeucarianThemeSpecimenRenderer
    {
        internal static void DrawThemePreview(
        ...
        internal static GUIStyle CreatePreviewTextStyle(
            Font font,
        ...
        internal static FontStyle ResolveUnityFontStyle(FontStyles styles, FontStyle fallback)
        {
        ...
        internal static Color ResolvePreviewColor(DeucarianTheme theme, string roleId, Color fallback)
        {
        ...
        internal static float ResolvePreviewControlHeight(DeucarianThemeDensity size)
        {
            switch (size)
            {
